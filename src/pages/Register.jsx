...
const Register = () => {
  ...
  return (
    <>
      <SEO 
        title="Đăng ký dịch vụ FPT Telecom"
        description="Đăng ký dịch vụ Internet, Truyền hình và các dịch vụ khác của FPT Telecom. Nhận ưu đãi lớn khi đăng ký trực tuyến."
        keywords="Đăng ký FPT, Lắp đặt mạng FPT, Đăng ký Internet FPT, Khuyến mãi FPT"
        url="https://fpttelecoms.com/register"
      />
